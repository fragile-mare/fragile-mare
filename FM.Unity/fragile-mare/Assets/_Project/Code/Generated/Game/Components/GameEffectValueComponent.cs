...
public partial class GameEntity {
    ...
    public _Project.Code.Gameplay.Features.Effect.EffectValue effectValue { get { return (_Project.Code.Gameplay.Features.Effect.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (_Project.Code.Gameplay.Features.Effect.EffectValue)CreateComponent(index, typeof(_Project.Code.Gameplay.Features.Effect.EffectValue));
