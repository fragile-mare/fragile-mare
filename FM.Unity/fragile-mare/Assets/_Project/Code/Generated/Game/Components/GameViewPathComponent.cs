...
public partial class GameEntity {
    ...
    public _Project.Code.Gameplay.Common.ViewPath viewPath { get { return (_Project.Code.Gameplay.Common.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (_Project.Code.Gameplay.Common.ViewPath)CreateComponent(index, typeof(_Project.Code.Gameplay.Common.ViewPath));
