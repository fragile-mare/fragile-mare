...
public partial class GameEntity {
    ...
    public _Project.Code.Gameplay.Features.Status.Radius radius { get { return (_Project.Code.Gameplay.Features.Status.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (_Project.Code.Gameplay.Features.Status.Radius)CreateComponent(index, typeof(_Project.Code.Gameplay.Features.Status.Radius));
