...
public partial class GameEntity {
    ...
    public _Project.Code.Gameplay.Common.WorldPosition worldPosition { get { return (_Project.Code.Gameplay.Common.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (_Project.Code.Gameplay.Common.WorldPosition)CreateComponent(index, typeof(_Project.Code.Gameplay.Common.WorldPosition));
