...
public partial class GameEntity {
    ...
    public _Project.Code.Gameplay.Features.Movement.Direction direction { get { return (_Project.Code.Gameplay.Features.Movement.Direction)GetComponent(GameComponentsLookup.Direction); } }
    ...
    public GameEntity AddDirection(UnityEngine.Vector2 newValue) {
        ...
        var component = (_Project.Code.Gameplay.Features.Movement.Direction)CreateComponent(index, typeof(_Project.Code.Gameplay.Features.Movement.Direction));
