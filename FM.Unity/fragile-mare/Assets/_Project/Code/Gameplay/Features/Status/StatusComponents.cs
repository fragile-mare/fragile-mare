...
namespace _Project.Code.Gameplay.Features.Status
{
    ...
    [Game] public class DurationTimer : IComponent { public float Value; }
    [Game] public class Expired : IComponent { }
    [Game] public class TargetVelocity : IComponent { public Vector3 Value; }
    [Game] public class AppliableAxis : IComponent { public Vector3 Value; }
